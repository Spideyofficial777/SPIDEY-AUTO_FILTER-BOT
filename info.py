...
# Bot information
SESSION = environ.get('SESSION', 'SPIDEYOFFICIAL')
...
PICS = (environ.get('PICS', 'https://graph.org/file/2518d4eb8c88f8f669f4c.jpg https://graph.org/file/d6d9d9b8d2dc779c49572.jpg https://graph.org/file/4b04eaad1e75e13e6dc08.jpg https://graph.org/file/05066f124a4ac500f8d91.jpg https://graph.org/file/2c64ed483c8fcf2bab7dd.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/9f3f47c690bbcc67633c2.jpg'))
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/i8a.jpg")).split()

# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5518489725 7965267063').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002294764885').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002453024937') # give your force subscribe channel id here else leave it blank
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002453024937')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002294764885')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002294764885')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://voromil970:q9aLNL7nsD8EDzwL@cluster0.rlvax.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "SPIDEYOFFICIAL")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Spideycollection')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/Pnp.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Spideyofficial777')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+9tdbATrOMLNlN2I1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Spideyofficial_777') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '09c3f9bc3a8b121b1e6b82a954e59da523dd188e')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 't.me/spideyofficial_777_/12')

# If You Fill Second Shortner Then Bot Attach Both First And Second Shortner And Use It For Verify.
VERIFY_SECOND_SHORTNER = bool(environ.get('VERIFY_SECOND_SHORTNER', True))
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'api.modijiurl.com')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', 'fb30c8d0baba3d820e2fb4576f8ea96df7ca04da')
...
TUTORIAL = environ.get('TUTORIAL', 't.me/spideyofficial_777/12') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
...
MSG_ALRT = environ.get('MSG_ALRT', 'ʜᴇʟʟᴏ ᴍʏ ᴅᴇᴀʀ ғʀɪᴇɴᴅꜱ ❤️')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://able-donnamarie-spideyxofficial-b13620b9.koyeb.app/")
